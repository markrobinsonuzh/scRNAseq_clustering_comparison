...
\begin{figure}[!h]
\includegraphics[width=7.5 in]{/Users/angeloduo/Desktop/masterarbeit/scRNAseq_clustering_comparison/results/QC_data/plot_data_tsne.pdf}
...
\begin{table}[htbp]
  ...
  \resizebox{\textwidth}{!}{%
    ...
    \toprule
    \textbf{Method} & \textbf{Parameter} & \textbf{Default} & \textbf{unfiltered} & \textbf{filtered} & \textbf{optimal k} \\
    \midrule
    \textbf{CIDR} & \multicolumn{1}{p{5.585em}}{k} & \multicolumn{1}{p{7.75em}}{NULL} & \multicolumn{1}{p{7.75em}}{3, 3, 4, 10, 4, 4} & \multicolumn{1}{p{7.75em}}{3, 3, 4, 9, 4, 4} & \multicolumn{1}{p{11.585em}}{3,3,5,13,4,4} \\
          & \multicolumn{1}{p{5.585em}}{nPC} & 4     & \multicolumn{1}{p{7.75em}}{5,10,8, 8, 3,3} & \multicolumn{1}{p{7.75em}}{5,10,8, 8, 3,3} & \multicolumn{1}{p{11.585em}}{5,10,8, 8, 3,3} \\
          & \multicolumn{1}{p{5.585em}}{cMethod} & \multicolumn{1}{p{7.75em}}{Ward.D2} & \multicolumn{1}{p{7.75em}}{Ward.D2} & \multicolumn{1}{p{7.75em}}{Ward.D2} & \multicolumn{1}{p{11.585em}}{Ward.D2} \\
    \midrule
    \textbf{tSNEkmeans} & \multicolumn{1}{p{5.585em}}{k} & \multicolumn{1}{p{7.75em}}{3,3,4,9,4,4} & \multicolumn{1}{p{7.75em}}{3, 3, 4, 10, 4, 4} & \multicolumn{1}{p{7.75em}}{3,3,4,9,4,4} & \multicolumn{1}{p{11.585em}}{3,3,4,12,3,3} \\
          & \multicolumn{1}{p{5.585em}}{perplexity} & 30    & 30    & 30    & 30 \\
          & \multicolumn{1}{p{5.585em}}{nPC} & 50    & 20    & 20    & 20 \\
    \midrule
    \textbf{pcaReduce} & \multicolumn{1}{p{5.585em}}{k} & \multicolumn{1}{p{7.75em}}{3,3,4,9,4,4} & \multicolumn{1}{p{7.75em}}{3, 3, 4, 10, 4, 4} & \multicolumn{1}{p{7.75em}}{3,3,4,9,4,4} & \multicolumn{1}{p{11.585em}}{5,3,5,11,4,4} \\
          & \multicolumn{1}{p{5.585em}}{nbt} & 100   & 100   & 100   & 100 \\
          & \multicolumn{1}{p{5.585em}}{method} & \multicolumn{1}{p{7.75em}}{S} & \multicolumn{1}{p{7.75em}}{S} & \multicolumn{1}{p{7.75em}}{S} & \multicolumn{1}{p{11.585em}}{S} \\
    \midrule
    \textbf{Linnorm} & \multicolumn{1}{p{5.585em}}{k} & \multicolumn{1}{p{7.75em}}{1  to 20} & \multicolumn{1}{p{7.75em}}{3, 3, 4, 10, 4, 4} & \multicolumn{1}{p{7.75em}}{3,3,4,9,4,4} & \multicolumn{1}{p{11.585em}}{3,2,5,11,3,3} \\
...
booktabs=T, caption.placement="top" , label="tblone")
)
@
