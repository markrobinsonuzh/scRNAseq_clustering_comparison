...
\begin{figure}[!h]
\includegraphics[width=7 in]{/Users/angeloduo/Desktop/masterarbeit/scRNAseq_clustering_comparison/results/QC_data/meanvarplots_simDataKumar.pdf}
...
\caption{Histogramm of simDataKumar. }
\label{fig:three}
\end{figure}
