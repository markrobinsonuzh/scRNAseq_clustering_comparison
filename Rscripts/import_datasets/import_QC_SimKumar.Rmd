---
title: "Import and QC of SimKumar"
output: html_document
editor_options: 
  chunk_output_type: console
---

# Load and process data set SimKumar (Kumar 2014)
...
pdf("../../plots/qc_data/qc_summary_SimKumar.pdf", width = 10, height = 12)
print(plot.qc)
dev.off()
```
...
saveRDS(sce.red, file = "../../data/sce_filtered/sce_filtered_SimKumar.rds")
```
