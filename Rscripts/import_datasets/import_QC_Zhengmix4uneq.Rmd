...
## Subsample
set.seed(1234)
b.cells <- b.cells[, sample(colnames(b.cells), 100, replace = FALSE)]
naive.cytotoxic <- naive.cytotoxic[, sample(colnames(naive.cytotoxic), 50, replace = FALSE)]
cd14.monocytes <- cd14.monocytes[, sample(colnames(cd14.monocytes), 200, replace = FALSE)]
regulatory.t <- regulatory.t[, sample(colnames(regulatory.t), 300, replace = FALSE)]
```
...
saveRDS(sce.red, file = "../../data/sce_filteredExpr/sce_filteredExpr_Zhengmix4uneq.rds")
