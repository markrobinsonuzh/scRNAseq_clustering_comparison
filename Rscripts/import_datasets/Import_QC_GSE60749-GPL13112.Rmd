---
title: "Import and QC of GSE60749-GPL13112"
...
pdf("../../plots/qc_data/qc_summary_GSE60749-GPL13112.pdf", width = 10, height = 12)
print(plot.qc)
dev.off()
```
...
```{r save-data}
saveRDS(sce, file = "../../data/sce_full/sce_full_GSE60749-GPL13112.rds")
saveRDS(sce.red, file = "../../data/sce_filtered/sce_filtered_GSE60749-GPL13112.rds")
```
