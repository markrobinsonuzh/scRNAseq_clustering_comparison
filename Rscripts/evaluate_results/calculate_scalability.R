...
## Run clustering
set.seed(1234)
scalability <- do.call(rbind, lapply(1:3, function(i) { ## three separate runs
  do.call(rbind, lapply(nbr_cells, function(nc) {  ## for each number of cells
    cat(paste0("nbr cells = ", nc, "(", i, ")\n"))
