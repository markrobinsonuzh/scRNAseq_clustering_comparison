#--------------------------------------
# Ensemble between methods, per run , k==truenclust
...
saveRDS(out2, file= paste0("output/ensemble/clustering_ensemble2_truenclust.rds" ) )
...
saveRDS(out3, file= paste0("output/ensemble/clustering_ensemble3_truenclust.rds" ) )
