...
file_names <- paste0("~/Desktop/masterthesis/results/PCAreduce/PCAreduce_clus_", 
...
file_names <-  paste0("~/Desktop/masterthesis/results/PCAreduce/PCAreduce_systime_",names(sys.time))
...
file_names <-  paste0("~/Desktop/masterthesis/results/PCAreduce/PCAreduce_labels_",names(sys.time), ".txt")
for (i in 1:length(sys.time)){
