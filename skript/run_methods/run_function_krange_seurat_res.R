...
k.param <- list(
  kumar2015 =ncol(data[["kumar2015"]])* c(0.025),
  trapnell2014 = ncol(data[["trapnell2014"]])*c(0.025),
  zhengmix2016 = ncol(data[["zhengmix2016"]])*c(0.025),
  koh2016 = ncol(data[["koh2016"]])*c(0.025),
  simDataKumar =ncol(data[["simDataKumar"]])*c(0.025)
)
par.dims.use <-  list(
  kumar2015 = 1:9,
  trapnell2014 = 1:12,
