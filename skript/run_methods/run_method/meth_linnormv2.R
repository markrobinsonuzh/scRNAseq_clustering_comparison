...
analyze_linnorm <- function(dataype, dataset) {
  ...
  # which parameter set
  if ((datatype=="filtered")| (datatype=="smooth")) {par.num_center <- par.num_center2; par.BE_strength <- par.BE_strength2}
  else if ((datatype == "unfiltered" ) ) {par.num_center <- par.num_center3; par.BE_strength <- par.BE_strength2}
  else if ((datatype == "default")) { par.num_center <- par.num_center1 ; par.BE_strength <- par.BE_strength1}
  else if ((datatype == "optimalk")) { par.num_center <- par.num_center4 ; par.BE_strength <- par.BE_strength2 }
  else {print("datatype not defined!") }
