...
dir_cluster <- paste0("results/SIMLRlargescale/SIMLRlargescale_clus_", names(res.cluster), ".txt")

save_clusters(res.cluster,dir_cluster)

# save systemtime

dir_systime <-  paste0("results/SIMLRlargescale/SIMLRlargescale_systime_",names(sys.time),".txt")

save_systemtime(sys.time, dir_systime)

# save experiment labels

file_names <-  paste0("results/SIMLRlargescale/SIMLRlargescale_labels_",names(labels), ".txt")
