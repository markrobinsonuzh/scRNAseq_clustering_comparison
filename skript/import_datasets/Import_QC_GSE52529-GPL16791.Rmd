...
selected_vars <- c("log10_total_counts", "log10_total_features", "pct_dropout",
               "pct_counts_top_200_features")

p1 <- plotPCA(sceset.red, exprs_values="exprs",pca_data_input="pdata", selected_variables=selected_vars)
p2 <- plotQC(sceset.red, type = "find-pcs", variable = "total_features")
